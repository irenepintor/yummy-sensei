...
const ItemDetail = ({ product }) => {
    ...
    return (
        <>
            <ProductCategories/>
            <div className="max-w-4xl mx-auto p-6 mt-5 mb-4 bg-white shadow-md rounded-lg flex flex-col md:flex-row">
                 <div className="w-full md:w-1/2">
                      <img className="w-full h-auto object-cover rounded-lg" src={product.image} alt={product.name} />
                 </div>
                 <div className="w-full md:w-1/2 mt-4 md:mt-0 md:pl-10">
